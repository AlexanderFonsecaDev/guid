...
<body>
                ...
                <div id="page-content">
                    ...
                    <div class="content-header">
                        <div class="header-section">
                            <h1>
                                <i class="hi hi-volume-up"></i>PUBLICIDAD<br><small>M&Oacute;DULO DE <strong>PUBLICIDAD WEB</strong></small>
                            </h1>
                        </div>
                    </div>
                    <ul class="breadcrumb breadcrumb-top">
                        <li>Men&uacute; </li>
                        <li>PUBLICIDAD <strong>WEB</strong></li>
                    </ul>
                    ...
                    <?php
                    require_once 'publicidad/dashboard.php';
                    ?>
    ...
    <script src="../elements/js/publicidad.js"></script>
