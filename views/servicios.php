...
<body>
                    ...
                    <div id="page-content">
                        ...
                        <div class="content-header">
                            <div class="header-section">
                                <h1>
                                    <i class="gi gi-server_new"></i>SERVICIOS<br><small>M&Oacute;DULOS DE SERVICIOS</small>
                                </h1>
                            </div>
                        </div>
                        ...
                        <?php
                            require_once 'zonas/infoZonas.php';
                        ?>
    ...
    <!-- Scroll to top link, initialized in js/app.js - scrollToTop() -->
        ...
        <script src="../elements/js/servicios.js"></script>
